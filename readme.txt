...
1. Upload the plugin folder to `/wp-content/plugins/`, or install the plugin from the WordPress Plugins screen.
...
6. Lessons, Quizzes, and Assignments
...
[Acadlix Documentation](https://acadlix.com/docs/acadlix/)