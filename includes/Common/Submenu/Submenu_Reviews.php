...
class Submenu_Reviews
{
  ...
  public function __construct()
  {
    $this->_options = [
      ...
      'page_title' => __('Acadlix Reviews', 'acadlix'),
      'menu_title' => __('Reviews', 'acadlix'),
      'capability' => 'acadlix_show_review',
      'menu_slug' => 'acadlix_review',
      'callback' => [$this, 'review_callback'],
      'position' => 360
    ];
  }
  ...
  {
    $enabled = acadlix()->helper()->acadlix_get_option('acadlix_enable_rating_and_reviews', 'yes');
    if ($enabled !== 'yes') {
      return;
    }
  ...
  {
    acadlix()->assets()->manager()->load_assets('admin_review', $this->localize_options());
  }

  public function review_callback()
  {
    echo '<div id="acadlix-admin-review"><h2>' . esc_html__('Loading...', 'acadlix') . '</h2></div>';
  }
