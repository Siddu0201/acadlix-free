  ...
  const methods = useForm({
    defaultValues: {
      ...
      enable_check_on_option_selected:
        Boolean(Number(props?.quiz?.enable_check_on_option_selected)),
      ...
      show_clear_response_button:
        Boolean(Number(props?.quiz?.show_clear_response_button)),
      ...
      enable_login_register:
        Boolean(Number(props?.quiz?.enable_login_register)),
      login_register_type:
      ...
      resume_unfinished_quiz:
        Boolean(Number(props?.quiz?.resume_unfinished_quiz)),
      show_only_specific_number_of_questions:
        Boolean(Number(props?.quiz?.show_only_specific_number_of_questions)),
      ...
      attempt_and_move_forward:
        Boolean(Number(props?.quiz?.attempt_and_move_forward)),
      force_user_to_answer_each_question:
        Boolean(Number(props?.quiz?.force_user_to_answer_each_question)),
      // Result settings
      ...
      show_subject_wise_analysis:
        Boolean(Number(props?.quiz?.show_subject_wise_analysis)),
      show_marks_distribution:
        Boolean(Number(props?.quiz?.show_marks_distribution)),
      show_status_based_on_min_percent:
        Boolean(Number(props?.quiz?.show_status_based_on_min_percent)),
      minimum_percent_to_pass: props?.quiz?.minimum_percent_to_pass ?? 0, // above 0 => pass
      result_comparision_with_top_five_student:
        Boolean(Number(props?.quiz?.result_comparision_with_top_five_student)),
      hide_answer_sheet: Boolean(Number(props?.quiz?.hide_answer_sheet)),
      show_per_question_time:
        Boolean(Number(props?.quiz?.show_per_question_time)),
      was_the_solution_helpful:
        Boolean(Number(props?.quiz?.was_the_solution_helpful)),
      bookmark: Boolean(Number(props?.quiz?.bookmark)),
      report_question_answer:
        Boolean(Number(props?.quiz?.report_question_answer)),
      ...
      leaderboard_user_can_apply_multiple_times:
        Boolean(Number(props?.quiz?.leaderboard_user_can_apply_multiple_times)),
      leaderboard_apply_multiple_number_of_times:
        props?.quiz?.leaderboard_apply_multiple_number_of_times ?
        Number(props?.quiz?.leaderboard_apply_multiple_number_of_times) : 0,
      ...
      percent_based_result_text:
        Boolean(Number(props?.quiz?.percent_based_result_text)),
      result_text: props?.quiz?.result_text ?? "", // ""/[{percent: number, text: ""}]
      // Notification settings
      admin_email_notification:
        Boolean(Number(props?.quiz?.admin_email_notification)),
      ...
      student_email_notification:
        Boolean(Number(props?.quiz?.student_email_notification)),
      ...
      instructor_email_notification:
        Boolean(Number(props?.quiz?.instructor_email_notification)),
