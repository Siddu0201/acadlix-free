          ...
          */}
          ...
          <GridItem1 xs={12} lg={4}>
            <FormControlLabel
              ...
              disabled={props?.watch("hide_result") || (props?.watch("mode") === "advance_mode" && props?.watch("advance_mode_type") !== "advance_panel")}
            />
          </GridItem1>
          ...
          <GridItem1 xs={12} lg={4}>
            <CustomTextField
              ...
              disabled={props?.watch("hide_result") || !props?.watch("show_status_based_on_min_percent")}
            />
          </GridItem1>
          ...
          <GridItem1 xs={12} lg={4}>
            <FormControlLabel
              ...
              disabled={props?.watch("hide_answer_sheet") || (props?.watch("mode") === "advance_mode" && props?.watch("advance_mode_type") !== "advance_panel")}
            />
          </GridItem1>
          ...
          <GridItem1 xs={12} lg={4}>
            <CustomTextField
              ...
              disabled={!props?.watch("leaderboard") || !props?.watch("leaderboard_user_can_apply_multiple_times")}
            />
          </GridItem1>
