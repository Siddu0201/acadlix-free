                                ...
                                children: [
                                  ...
                                  props?.watch("order_items")?.length > 0 && ({
                                    ...
                                    children: [
                                      ...
                                      {
                                        component: "TableRow",
                                        component_name: "order_items_price_after_discount_row",
                                        children: [
                                          {
                                            component: "TableCell",
                                            component_name: "order_items_total_price_after_discount_label_table_cell",
                                            value: __("Price After Discount", "acadlix")
                                          },
                                          {
                                            component: "TableCell",
                                            component_name: "order_items_total_price_after_discount_value_table_cell",
