						...
						children: [
							...
							},
							{
								...
								children: [
									...
									{
										component: "Grid",
										component_name: "order_details_transaction_id_label_grid_item",
										props: {
											size: { xs: 12, sm: 6, lg: 3 },
										},
										children: [
											{
												component: "CustomTypography",
												component_name: "order_details_transaction_id_label_custom_typography",
									...
									{
										component: "Grid",
										component_name: "order_details_transaction_id_value_grid_item",
										props: {
									...
									{
										component: "Grid",
										component_name: "order_details_coupon_code_label_grid_item",
										props: {
											size: { xs: 12, sm: 6, lg: 3 },
										},
										children: [
											{
												component: "CustomTypography",
												component_name: "order_details_coupon_code_label_custom_typography",
												value: __("Coupon Code", "acadlix")
											}
										]
									},
									{
										component: "Grid",
										component_name: "order_details_coupon_code_value_grid_item",
										props: {
											size: { xs: 12, sm: 6, lg: 3 },
										},
										children: [
											{
												component: "Link",
												component_name: "order_details_coupon_code_value_custom_typography",
												props: {
													href: props?.watch("coupon_id") ? `${acadlixOptions?.acadlix_coupon_url}#/edit/${props?.watch("coupon_id")}` : "#",
													target: "_blank",
												},
												value: props?.watch("coupon_code") ?? "N/A",
											}
										]
									},
