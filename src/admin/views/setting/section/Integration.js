...
const Integration = (props) => {
  ...
  const defaultSetting = {
    component: "Grid",
    component_name: "setting_integration_grid_container",
    props: {
      container: true,
      spacing: 4,
    },
    children: [
      {
        component: "Grid",
        component_name: "setting_integration_grid_item",
        props: {
          size: { xs: 12, sm: 12 },
        },
        children: [
      ...
      {
        component: "Grid",
        component_name: "setting_integration_grid_item_save",
        props: {
          size: { xs: 12, sm: 12 },
          sx: {
            position: "sticky",
        ...
        children: [
          {
            component: "Card",
            component_name: "setting_integration_card_save",
            children: [
              {
                component: "CardContent",
                component_name: "setting_integration_card_content_save",
                props: {
                  sx: {
                    padding: 4,
                    ":last-child": {
