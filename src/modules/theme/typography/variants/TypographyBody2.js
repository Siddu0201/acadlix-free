...
const TypographyBody2 = (props) => {
    return (
        ...
        >
            ...
            >
                <CustomFontSize
                    name={`typography.body2.fontSize.${props?.type}`}
                    {...props}
                />
            </Grid>
            <Grid
            ...
            >
                <CustomFontWeight
                    name={`typography.body2.fontWeight.${props?.type}`}
                    {...props}
                />
            </Grid>
            <Grid
            ...
            >
                <CustomLineHeight
                    name={`typography.body2.lineHeight.${props?.type}`}
                    {...props}
                />
            </Grid>
            <Grid
            ...
            >
                <CustomLetterSpacing
                    name={`typography.body2.letterSpacing.${props?.type}`}
                    {...props}
                />
            </Grid>
        </Grid>
