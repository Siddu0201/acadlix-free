...
const TypographyH3 = (props) => {
    return (
        ...
        >
            ...
            >
                <CustomFontSize
                    name={`typography.h3.fontSize.${props?.type}`}
                    {...props}
                />
            </Grid>
            <Grid
            ...
            >
                <CustomFontWeight
                    name={`typography.h3.fontWeight.${props?.type}`}
                    {...props}
                />
            </Grid>
            <Grid
            ...
            >
                <CustomLineHeight
                    name={`typography.h3.lineHeight.${props?.type}`}
                    {...props}
                />
            </Grid>
            <Grid
            ...
            >
                <CustomLetterSpacing
                    name={`typography.h3.letterSpacing.${props?.type}`}
                    {...props}
                />
            </Grid>
        </Grid>
