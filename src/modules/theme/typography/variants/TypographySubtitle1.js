...
const TypographySubtitle1 = (props) => {
    return (
        <Grid
            container
            spacing={{
        ...
        >
            ...
            >
                <CustomFontSize
                    name={`typography.subtitle1.fontSize.${props?.type}`}
                    {...props}
                />
            </Grid>
            <Grid
            ...
            >
                <CustomFontWeight
                    name={`typography.subtitle1.fontWeight.${props?.type}`}
                    {...props}
                />
            </Grid>
            <Grid
            ...
            >
                <CustomLineHeight
                    name={`typography.subtitle1.lineHeight.${props?.type}`}
                    {...props}
                />
            </Grid>
            <Grid
            ...
            >
                <CustomLetterSpacing
                    name={`typography.subtitle1.letterSpacing.${props?.type}`}
                    {...props}
                />
            </Grid>
        </Grid>
