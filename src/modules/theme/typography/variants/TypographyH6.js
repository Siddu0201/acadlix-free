...
const TypographyH6 = (props) => {
    return (
        ...
        >
            ...
            >
                <CustomFontSize
                    name={`typography.h6.fontSize.${props?.type}`}
                    {...props}
                />
            </Grid>
            <Grid
            ...
            >
                <CustomFontWeight
                    name={`typography.h6.fontWeight.${props?.type}`}
                    {...props}
                />
            </Grid>
            <Grid
            ...
            >
                <CustomLineHeight
                    name={`typography.h6.lineHeight.${props?.type}`}
                    {...props}
                />
            </Grid>
            <Grid
            ...
            >
                <CustomLetterSpacing
                    name={`typography.h6.letterSpacing.${props?.type}`}
                    {...props}
                />
            </Grid>
        </Grid>
