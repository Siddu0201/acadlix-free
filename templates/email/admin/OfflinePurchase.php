...
<head>
    ...
    <title><?php echo sprintf(
        ...
        __('New Offline Purchase for Order #%d', 'acadlix'), $order_id); ?></title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h2><?php echo sprintf(
                /* translators: %d is the order ID */
                __('New Offline Purchase for Order #%d', 'acadlix'), $order_id); ?></h2>
        </div>
        <div class="content">
            ...
            <p><?php echo __('Please review the payment proof and update the order status as appropriate.', 'acadlix'); ?></p>
