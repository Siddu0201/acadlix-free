...
<head>
    ...
    <style>
        body {
            ...
            color: <?php echo esc_attr($acadlix_textPrimary); ?>;
        }
        .container {
            max-width: 600px;
            margin: 20px auto;
        ...
        .header {
            text-align: center;
            background: <?php echo esc_attr($acadlix_primaryMain); ?>;
            color: #ffffff;
            padding: 16px;
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p><?php echo esc_html__('You can review their progress in the admin panel.', 'acadlix'); ?></p>

        </div>

        <!-- Footer -->
        <div class="footer">
            <p>&copy; <?php echo esc_html($year); ?> <?php echo esc_html($sitename); ?>. <?php echo esc_html__('All rights reserved.', 'acadlix'); ?></p>
        </div>
    </div>
</body>
</html>
