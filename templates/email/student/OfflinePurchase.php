...
<head>
    ...
    <title><?php echo sprintf(
        ...
        __('Offline Purchase for order #%d', 'acadlix'), $order_id); ?></title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="header">
            <h2><?php echo sprintf(
                /* translators: %d is the order ID */
                __('Offline Purchase Initiated for Order #%d', 'acadlix'), $order_id); ?></h2>
        </div>
        ...
        <div class="content">
            ...
            <p><?php echo sprintf(
                ...
                __('Thank you for choosing the offline payment method for %s. Your order has been received and is currently pending verification.', 'acadlix'), esc_html($course_names)); ?></p>
            ...
            <ul>
                ...
                <li><strong><?php echo __('Amount to Pay:', 'acadlix'); ?></strong> <?php echo esc_html($order_amount); ?></li>
            ...
            <p><?php echo __('If you have already submitted your payment proof, our team will review and update your order status soon. For any questions or assistance, please contact our support team.', 'acadlix'); ?></p>
        </div>
