...
<head>
    ...
    <title><?php echo esc_html(sprintf(
        ...
        __('✅ Your order #%d is confirmed', 'acadlix'),
        $order_id
    )); ?></title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p><?php echo esc_html(sprintf(
                /* translators: %d: order id */
                __('Thank you for your purchase! Your order #%d has been successfully placed. 🎉', 'acadlix'),
                $order_id
            )); ?>
            </p>
            ...
            <p><?php echo esc_html__('If you have any questions, feel free to reach out to our support team.', 'acadlix'); ?>
            </p>
        </div>
